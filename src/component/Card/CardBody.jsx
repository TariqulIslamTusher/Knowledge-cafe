            ...
            <div className="card-body">
                <div className='card-container flex items-center sm:justify-between flex-col gap-4 sm:flex-row'>
                    ...
                    <div className='flex gap-3'>
                        ...
                        <button onClick={()=> handleBlog(id)} className='btn-sm btn-circle'>
                ...
                <div className="card-actions">
                    ...
                    <a onClick={()=> handleWatchTime(id)} className='text-blue-700 text-lg cursor-pointer active:text-red-900'>Mark as read</a>
                </div>
            </div>
        </div>
    );
